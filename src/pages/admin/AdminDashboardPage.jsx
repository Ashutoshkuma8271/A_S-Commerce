...
export const AdminDashboardPage = () => {
  ...
  useEffect(() => {
    // Initial mount: load data silently without redundant notification
  ...
  const getNextStatusAction = (currentStatus) => {
    ...
    if (s.includes('place') || s.includes('confirm')) {
      return { next: 'Processing', label: 'Start Processing', color: 'bg-amber-500/20 text-amber-700 dark:text-amber-400 border-amber-500/40 hover:bg-amber-500/30' };
    }
    if (s.includes('process') || s.includes('pack')) {
      return { next: 'Shipped', label: 'Dispatch & Ship', color: 'bg-sky-500/20 text-sky-700 dark:text-sky-400 border-sky-500/40 hover:bg-sky-500/30' };
    }
    if (s.includes('out for delivery') || s.includes('ship') || s.includes('transit')) {
      return { next: 'Delivered', label: 'Mark Delivered', color: 'bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 border-emerald-500/40 hover:bg-emerald-500/30' };
    }
    return null;
  };
  ...
  const renderSkeletonContent = () => {
            ...
            {[...Array(4)].map((_, i) => (
              <div key={i} className="p-6 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200 dark:border-gold-500/10 shadow-sm dark:shadow-xl space-y-4 animate-pulse">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 rounded-2xl bg-gray-200 dark:bg-navy-800" />
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 p-6 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200 dark:border-gold-500/10 shadow-sm dark:shadow-xl space-y-4">
              ...
              <div className="space-y-3">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="p-4 rounded-2xl bg-gray-50 dark:bg-navy-850 border border-gray-200 dark:border-navy-800 flex items-center justify-between gap-4 animate-pulse">
            ...
            <div className="lg:col-span-5 p-6 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200 dark:border-gold-500/10 shadow-sm dark:shadow-xl space-y-4">
              ...
              <div className="space-y-3">
                {[...Array(5)].map((_, i) => (
                  <div key={i} className="p-3 rounded-xl bg-gray-50 dark:bg-navy-850 border border-gray-200 dark:border-navy-800 space-y-2 animate-pulse">
                    <div className="flex items-center justify-between">
    ...
    if (activeTab === 'products' || activeTab === 'orders' || activeTab === 'coupons' || activeTab === 'audit' || activeTab === 'customers') {
      return (
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200 dark:border-gold-500/10 shadow-sm dark:shadow-xl space-y-6 animate-fadeIn">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 dark:border-navy-800 pb-4">
            ...
            {activeTab === 'products' && (
              <div className="h-10 w-36 bg-gray-200 dark:bg-navy-850 rounded-xl animate-pulse" />
            )}
          </div>

          {/* Search/Filters Skeleton */}
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="h-10 flex-1 bg-gray-100 dark:bg-navy-850 rounded-xl border border-gray-200 dark:border-navy-700 animate-pulse" />
            <div className="h-10 w-40 bg-gray-100 dark:bg-navy-850 rounded-xl border border-gray-200 dark:border-navy-700 animate-pulse" />
          </div>

          {/* Table List Skeleton */}
          <div className="overflow-x-auto space-y-3">
            <div className="h-10 bg-gray-100 dark:bg-navy-950 rounded-t-xl animate-pulse flex items-center px-4 justify-between border-b border-gray-200 dark:border-navy-800">
            ...
            {[...Array(5)].map((_, i) => (
              <div key={i} className="p-4 bg-gray-50 dark:bg-navy-850 border border-gray-200 dark:border-navy-800 rounded-xl flex items-center justify-between gap-4 animate-pulse">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gray-200 dark:bg-navy-800 shrink-0" />
                ...
                <div className="h-3.5 w-24 bg-gray-200 dark:bg-navy-800 rounded" />
                <div className="h-3.5 w-16 bg-gray-200 dark:bg-navy-800 rounded" />
                <div className="h-8 w-16 bg-gray-200 dark:bg-navy-800 rounded-lg" />
              </div>
            ))}
          </div>
        </div>
    ...
    return (
      <div className="p-8 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200 dark:border-gold-500/10 shadow-sm dark:shadow-xl flex flex-col items-center justify-center space-y-4 animate-pulse">
        <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-navy-850 border border-gray-200 dark:border-navy-700 animate-spin border-t-gold-500" />
        <div className="h-4 w-32 bg-gray-200 dark:bg-navy-850 rounded" />
      </div>
    );
  };
      ...
      <header className="bg-white/95 dark:bg-navy-900/95 border-b border-gray-200/80 dark:border-gold-500/20 px-4 sm:px-8 py-3.5 flex items-center justify-between sticky top-0 z-30 shadow-sm dark:shadow-xl backdrop-blur-md transition-colors">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <Link
            to="/"
            target="_blank"
            className="flex items-center gap-1.5 text-xs text-gray-700 dark:text-gray-300 hover:text-navy-950 dark:hover:text-gold-400 font-semibold px-3 py-1.5 rounded-xl bg-gray-100 hover:bg-gray-200 dark:bg-navy-800 dark:hover:bg-navy-750 border border-gray-200 dark:border-navy-700 transition-colors"
          >
          ...
          <div className="flex items-center gap-3">
            <div className="text-right hidden md:block">
              ...
              <p className="text-[10px] font-mono text-gold-600 dark:text-gold-400">Master Administrator</p>
            </div>
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 border-b border-gray-200 dark:border-navy-800">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap cursor-pointer ${isActive
                    ...
                    : 'bg-white dark:bg-navy-900 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-navy-850 hover:text-navy-950 dark:hover:text-white border border-gray-200 dark:border-navy-800 shadow-xs'
                  }`}
              >
          ...
          <button
            ...
            className="ml-auto p-2.5 rounded-xl bg-white dark:bg-navy-900 text-gray-700 dark:text-gray-400 hover:text-gold-600 dark:hover:text-gold-400 border border-gray-200 dark:border-navy-800 transition-colors cursor-pointer shadow-xs"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  <div className="lg:col-span-7 p-6 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200/80 dark:border-gold-500/20 shadow-sm dark:shadow-xl space-y-4 transition-colors">
                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-navy-800 pb-3">
                      ...
                      <button onClick={() => setActiveTab('orders')} className="text-xs text-gold-700 dark:text-gold-400 hover:underline font-semibold cursor-pointer">
                        Manage Orders →
                      </button>
                    </div>
                      ...
                      {orders.slice(0, 4).map((order) => (
                        <div key={order.id} className="p-4 rounded-2xl bg-gray-50 dark:bg-navy-850 border border-gray-200/80 dark:border-navy-800 flex items-center justify-between gap-4">
                          ...
                          <div className="text-right space-y-1">
                            ...
                            <span className="inline-block px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-gold-500/20 text-gold-700 dark:text-gold-400 border border-gold-500/30">
                              {order.status}
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="lg:col-span-5 p-6 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200/80 dark:border-gold-500/20 shadow-sm dark:shadow-xl space-y-4 transition-colors">
                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-navy-800 pb-3">
                      <h4 className="font-serif text-lg font-bold text-navy-950 dark:text-white flex items-center gap-2">
                        <History className="w-5 h-5 text-gold-600 dark:text-gold-400" />
                        <span>Security Audit Feed</span>
                      </h4>
                      <button onClick={() => setActiveTab('audit')} className="text-xs text-gold-700 dark:text-gold-400 hover:underline font-semibold cursor-pointer">
                        Full Log →
                      </button>
                    </div>
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200/80 dark:border-gold-500/20 shadow-sm dark:shadow-xl space-y-6 smooth-section-enter animate-fadeIn transition-colors">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1">
                    <Search className="w-4 h-4 text-gray-500 dark:text-gray-400 absolute left-3.5 top-3" />
                    <input
                      type="text"
                      value={productSearch}
                      onChange={(e) => setProductSearch(e.target.value)}
                      placeholder="Search products by title or brand..."
                      className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-navy-850 text-navy-950 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 text-xs rounded-xl border border-gray-200 dark:border-navy-700 focus:border-gold-500"
                    />
                  </div>
                  ...
                  <select
                    ...
                    className="px-4 py-2.5 bg-gray-50 dark:bg-navy-850 text-gold-700 dark:text-gold-400 rounded-xl border border-gray-200 dark:border-navy-700 text-xs font-semibold focus:border-gold-500 cursor-pointer"
                  >
                  ...
                  <table className="w-full text-left text-xs text-gray-800 dark:text-gray-200">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-navy-800">
                      {filteredProducts.map((prod) => (
                        <tr key={prod.id} className="hover:bg-amber-500/5 dark:hover:bg-navy-850/50 transition-colors">
                          <td className="p-3.5">
                            <div className="flex items-center gap-3">
                              <img
                                src={prod.images ? prod.images[0] : prod.image}
                                alt={prod.name}
                                className="w-10 h-10 rounded-xl object-cover border border-gray-200 dark:border-navy-700 shrink-0"
                              />
                              <div>
                          ...
                          <td className="p-3.5">
                            {prod.badge && (
                              <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-gold-500/20 text-gold-700 dark:text-gold-400 border border-gold-500/30">
                                {prod.badge}
                              </span>
                            )}
                          </td>
                          <td className="p-3.5 text-right space-x-2 whitespace-nowrap">
                            <button
                              ...
                              className="p-1.5 text-gray-600 hover:text-gold-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gold-400 dark:hover:bg-navy-800 rounded-lg transition-colors cursor-pointer"
                              title="Edit Product"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 text-gray-600 hover:text-red-600 hover:bg-red-50 dark:text-gray-400 dark:hover:text-red-400 dark:hover:bg-navy-800 rounded-lg transition-colors cursor-pointer"
                ...
                <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200/80 dark:border-gold-500/20 shadow-sm dark:shadow-xl space-y-6 transition-colors">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 dark:border-navy-800 pb-4">
                    ...
                    <div className="flex items-center flex-wrap gap-2">
                      <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-xs border border-emerald-500/20 font-semibold">
                        <span className="w-2 h-2 rounded-full bg-emerald-500 dark:bg-emerald-400 animate-pulse" />
                        <span>Live Database Sync</span>
                      </span>
                      <button
                        onClick={handleExportOrdersCSV}
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gray-100 hover:bg-gray-200 dark:bg-navy-800 dark:hover:bg-navy-750 text-gold-700 dark:text-gold-400 hover:text-gold-800 dark:hover:text-gold-300 text-xs border border-gray-200 dark:border-gold-500/30 transition-colors cursor-pointer font-semibold"
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                    ...
                    <div className="p-4 rounded-2xl bg-amber-500/10 dark:bg-navy-850 border border-amber-500/30 space-y-1">
                      <span className="text-[10px] text-amber-700 dark:text-amber-400 uppercase font-semibold tracking-wider">Pending Fulfillment</span>
                      <div className="flex items-baseline justify-between">
                    ...
                    <div className="p-4 rounded-2xl bg-sky-500/10 dark:bg-navy-850 border border-sky-500/30 space-y-1">
                      <span className="text-[10px] text-sky-700 dark:text-sky-400 uppercase font-semibold tracking-wider">In Transit Logistics</span>
                      <div className="flex items-baseline justify-between">
                        <span className="text-xl sm:text-2xl font-bold font-serif text-sky-700 dark:text-sky-400">
                          {orders.filter(o => ['Shipped', 'In Transit', 'Out for Delivery'].includes(o.status)).length}
                        </span>
                        <span className="text-[10px] text-sky-700 dark:text-sky-400/80 font-medium">With Courier</span>
                      </div>
                    </div>

                    <div className="p-4 rounded-2xl bg-emerald-500/10 dark:bg-navy-850 border border-emerald-500/30 space-y-1">
                      <span className="text-[10px] text-emerald-700 dark:text-emerald-400 uppercase font-semibold tracking-wider">Delivered & Complete</span>
                      <div className="flex items-baseline justify-between">
                        <span className="text-xl sm:text-2xl font-bold font-serif text-emerald-700 dark:text-emerald-400">
                          {orders.filter(o => o.status === 'Delivered').length}
                        </span>
                        <span className="text-[10px] text-emerald-700 dark:text-emerald-400/80 font-medium">Fulfilled</span>
                      </div>
                    </div>
                  </div>

                  {/* Status Pipeline Filter Tabs */}
                  <div className="flex items-center gap-1.5 overflow-x-auto pb-1 border-b border-gray-200 dark:border-navy-800 scrollbar-none">
                    {[
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
                    <div className="sm:col-span-6 relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3.5 py-2.5 bg-gray-50 dark:bg-navy-850 text-navy-950 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 rounded-xl border border-gray-200 dark:border-navy-700 text-xs focus:border-gold-500"
                      />
                      {orderSearch && (
                        <button
                ...
                <div className="space-y-4">
                  {visibleOrders.map((order) => {
                      ...
                      const statusColors = {
                        ...
                        'Out for Delivery': 'bg-purple-500/15 text-purple-700 dark:text-purple-400 border-purple-500/30',
                        Shipped: 'bg-sky-500/15 text-sky-700 dark:text-sky-400 border-sky-500/30',
                        'In Transit': 'bg-sky-500/15 text-sky-700 dark:text-sky-400 border-sky-500/30',
                        Processing: 'bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/30',
                        'Payment Confirmed': 'bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-500/30',
                        'Order Placed': 'bg-gold-500/20 text-gold-700 dark:text-gold-400 border-gold-500/40',
                        Cancelled: 'bg-red-500/15 text-red-700 dark:text-red-400 border-red-500/30',
                      };
                      const badgeClass = statusColors[currentStatus] || 'bg-gold-500/15 text-gold-700 dark:text-gold-400 border-gold-500/30';
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-gray-200 dark:border-navy-800 pb-4">
                            <div className="space-y-1.5">
                              <div className="flex items-center flex-wrap gap-2.5">
                                <div className="flex items-center gap-1.5 bg-gray-100 dark:bg-navy-850 px-3 py-1 rounded-xl border border-gray-200 dark:border-navy-750">
                                  <span className="text-xs font-mono font-bold text-gold-700 dark:text-gold-400">#{order.id}</span>
                                  <button
                                    onClick={() => handleCopyText(order.id, `order-${order.id}`, 'Consignment ID')}
                                    className="text-gray-500 hover:text-navy-950 dark:text-gray-400 dark:hover:text-white p-0.5 transition-colors cursor-pointer"
                                    title="Copy Order ID"
                                  >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {nextAction && currentStatus !== 'Cancelled' && (
                                  <button
                                    ...
                                    className={`flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold border transition-all cursor-pointer shadow-xs hover:brightness-105 ${nextAction.color}`}
                                ...
                                <select
                                  ...
                                  className="px-2.5 py-2 bg-gray-100 dark:bg-navy-850 text-gold-700 dark:text-gold-400 border border-gray-200 dark:border-navy-700 rounded-xl text-xs font-bold focus:border-gold-500 focus:outline-none cursor-pointer"
                                >
                          ...
                          {currentStatus !== 'Cancelled' && (
                            <div className="bg-gray-50/80 dark:bg-navy-850/70 p-4 rounded-2xl border border-gray-200 dark:border-navy-800">
                              <div className="grid grid-cols-4 gap-2 sm:gap-4">
                                {stages.map((stage, sIdx) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      <div
                                        className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all border ${isCurrent
                            ...
                            <div className="bg-gray-50/60 dark:bg-navy-850/40 rounded-2xl p-4 border border-gray-200 dark:border-navy-800/80 space-y-2.5">
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                                {order.items.map((item, idx) => (
                                  <div
                                    key={idx}
                                    className="flex items-center gap-3 p-2.5 rounded-xl bg-white dark:bg-navy-850 border border-gray-200 dark:border-navy-800 text-xs shadow-xs"
                                  >
                                    <img
                                      src={item.image || item.images?.[0] || 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=100'}
                                      alt={item.name}
                                      className="w-12 h-12 object-cover rounded-lg border border-gray-200 dark:border-navy-750 shrink-0"
                                    />
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                {order.shippingAddress?.city && (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="text-[10px] text-gold-700 dark:text-gold-400 hover:underline flex items-center gap-1 font-semibold"
                                  >
                            ...
                            <div className="md:col-span-6 bg-gray-50/80 dark:bg-navy-850/50 p-4 rounded-2xl border border-gray-200 dark:border-navy-800 space-y-1.5">
                              ...
                              <div className="text-gray-800 dark:text-gray-200 space-y-1">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="font-mono text-gold-700 dark:text-gold-400 font-bold bg-gray-200 dark:bg-navy-900 px-2 py-0.5 rounded border border-gray-300 dark:border-navy-750 text-[11px]">
                                    {order.trackingNumber || 'Pending AWB'}
                                  </span>
                                  {order.trackingNumber && (
                                    <button
                                      onClick={() => handleCopyText(order.trackingNumber, `trk-${order.id}`, 'AWB Tracking Number')}
                                      className="text-gray-500 hover:text-navy-950 dark:text-gray-400 dark:hover:text-white p-0.5 cursor-pointer"
                          ...
                          <div className="flex items-center flex-wrap justify-between gap-3 pt-2 border-t border-gray-200 dark:border-navy-800">
                            ...
                            <div className="flex items-center gap-2">
                              {cleanPhone && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-xs border border-emerald-500/30 transition-colors font-medium"
                                >
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gray-100 hover:bg-gray-200 dark:bg-navy-800 dark:hover:bg-navy-750 text-gold-700 dark:text-gold-400 border border-gray-200 dark:border-gold-500/30 text-xs font-bold transition-colors cursor-pointer"
                              >
                      ...
                      {filteredCustomers.map((customer) => (
                          <tr key={customer.id} className="hover:bg-gray-50 dark:hover:bg-navy-850/50 transition-colors">
                            <td className="py-3.5 px-4">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-gold-500/10 border border-gold-500/30 flex items-center justify-center font-bold font-serif text-gold-600 dark:text-gold-400 text-xs">
                            ...
                            <td className="py-3.5 px-4">
                              {customer.isVerified ? (
                                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 text-[10px] font-bold font-mono">
                                  <CheckCircle2 className="w-3 h-3" />
                                  <span>Verified OTP</span>
                                </span>
                              ) : (
                                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-500/15 text-amber-600 dark:text-amber-400 border border-amber-500/30 text-[10px] font-bold font-mono">
                            ...
                            <td className="py-3.5 px-4">
                              <span className="px-2.5 py-1 rounded-lg bg-gray-100 dark:bg-navy-800 text-gold-700 dark:text-gold-400 border border-gray-200 dark:border-navy-700 font-mono font-bold text-xs">
                            ...
                            <td className="py-3.5 px-4 text-right">
                              <button
                                ...
                                className="p-2 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-600 dark:text-red-400 border border-red-500/20 transition-all hover:scale-105 cursor-pointer inline-flex items-center gap-1"
                              >
            ...
            {activeTab === 'settings' && (
              <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200/80 dark:border-gold-500/20 shadow-sm dark:shadow-xl space-y-6 smooth-section-enter animate-fadeIn transition-colors">
                ...
                <form onSubmit={handleSaveSettings} className="space-y-6 text-xs max-w-2xl">
                  <div className="space-y-4">
                    <h4 className="text-xs font-bold text-gold-700 dark:text-gold-400 uppercase tracking-widest border-b border-gray-200 dark:border-navy-800 pb-2">
                      1. Announcement Bar
                    </h4>
                    <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 smooth-section-enter animate-fadeIn">
                ...
                <div className="lg:col-span-7 p-6 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200/80 dark:border-gold-500/20 shadow-sm dark:shadow-xl space-y-4 transition-colors">
                  <h3 className="font-serif text-lg font-bold text-navy-950 dark:text-white flex items-center gap-2 border-b border-gray-100 dark:border-navy-800 pb-3">
                    <Tag className="w-5 h-5 text-gold-500 dark:text-gold-400" />
                  ...
                  <div className="space-y-3">
                    {coupons.map((coupon) => (
                      <div key={coupon.code} className="p-4 rounded-2xl bg-gray-50 dark:bg-navy-850 border border-gray-200/80 dark:border-navy-800 flex items-center justify-between gap-4">
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="font-mono text-sm font-bold text-gold-700 dark:text-gold-400 bg-gold-500/10 dark:bg-navy-950 px-2.5 py-0.5 rounded-lg border border-gold-500/30">
                              {coupon.code}
                            </span>
            ...
            {activeTab === 'audit' && (
              <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200/80 dark:border-gold-500/20 shadow-sm dark:shadow-xl space-y-6 smooth-section-enter animate-fadeIn transition-colors">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 dark:border-navy-800 pb-4">
                  ...
                  <span className="text-xs font-mono text-gold-700 dark:text-gold-400 bg-gold-500/10 px-3 py-1 rounded-full border border-gold-500/30 w-max font-semibold">
            ...
            {activeTab === 'profile' && (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 smooth-section-enter animate-fadeIn">
                ...
                <div className="md:col-span-7 p-6 rounded-3xl bg-white dark:bg-navy-900 border border-gray-200/80 dark:border-gold-500/20 shadow-sm dark:shadow-xl space-y-5 transition-colors">
                  <h3 className="font-serif text-lg font-bold text-navy-950 dark:text-white flex items-center gap-2 border-b border-gray-100 dark:border-navy-800 pb-3">
                    <KeyRound className="w-5 h-5 text-gold-500 dark:text-gold-400" />
          ...
          <div className="relative w-full max-w-2xl bg-white dark:bg-navy-900 border border-gray-200 dark:border-gold-500/30 rounded-3xl p-6 sm:p-8 shadow-2xl z-10 max-h-[90vh] overflow-y-auto space-y-5 text-navy-950 dark:text-white">
            ...
            <form onSubmit={handleSaveProduct} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    <label className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 dark:bg-navy-800 dark:hover:bg-navy-750 text-gold-700 dark:text-gold-400 border border-gold-500/30 text-xs font-semibold cursor-pointer transition-colors shrink-0">
                  ...
                  {productForm.image && (
                    <div className="flex items-center gap-3 p-2 rounded-xl bg-gray-50 dark:bg-navy-950/60 border border-gray-200 dark:border-navy-800">
                      <img
            ...
            <form onSubmit={handleSaveOrderDelivery} className="space-y-4 text-xs">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-gray-50 dark:bg-navy-850 text-gold-700 dark:text-gold-400 font-bold rounded-xl border border-gray-200 dark:border-navy-700 focus:border-gold-500 cursor-pointer"
                >
          ...
          <div className="relative w-full max-w-3xl bg-white dark:bg-navy-900 border border-gray-200 dark:border-gold-500/30 rounded-3xl p-6 sm:p-8 shadow-2xl z-10 max-h-[90vh] overflow-y-auto space-y-6 text-navy-950 dark:text-white">
            ...
            <div className="flex items-center justify-between border-b border-gray-100 dark:border-navy-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2.5">
                  <h3 className="font-serif text-lg sm:text-xl font-bold text-navy-950 dark:text-white">
                    Consignment Dossier #{selectedOrderDossier.id}
                  </h3>
                  <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-gold-500/10 dark:bg-gold-500/20 text-gold-700 dark:text-gold-400 border border-gold-500/40">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gray-100 hover:bg-gray-200 dark:bg-navy-800 dark:hover:bg-navy-750 text-gold-700 dark:text-gold-400 border border-gold-500/30 text-xs font-semibold transition-colors cursor-pointer"
            ...
            <div id="printable-order-invoice" className="space-y-6 text-xs text-gray-800 dark:text-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-2xl bg-gray-50 dark:bg-navy-850 border border-gray-200/80 dark:border-navy-800 space-y-2">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-gray-200 dark:border-navy-800">
                    {(selectedOrderDossier.customerPhone || selectedOrderDossier.shippingAddress?.phone) && (
                      <a
                        href={`https://wa.me/91${(selectedOrderDossier.customerPhone || selectedOrderDossier.shippingAddress?.phone || '').replace(/[^0-9]/g, '')}`}
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[10px] font-semibold hover:bg-emerald-500/20 border border-emerald-500/30"
                      >
              ...
              <div className="space-y-2">
                ...
                <div className="overflow-x-auto rounded-2xl border border-gray-200 dark:border-navy-800 bg-white dark:bg-navy-850">
                  <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-navy-800/60 text-gray-800 dark:text-gray-200">
            ...
            <div className="flex items-center justify-between border-t border-gray-100 dark:border-navy-800 pt-4">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 dark:bg-navy-800 dark:hover:bg-navy-750 text-gold-700 dark:text-gold-400 border border-gold-500/30 text-xs font-semibold transition-colors cursor-pointer"
              >
                <Truck className="w-3.5 h-3.5" />
