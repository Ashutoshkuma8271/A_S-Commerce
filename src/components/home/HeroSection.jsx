...
const HERO_SLIDES = [
  {
    id: 1,
    badge: 'HAUTE HORLOGERIE 2026',
    tag: 'Swiss Precision Timepieces',
    titleLine1: 'Mastery of Time.',
    titleLine2: '24K Gold Chronographs.',
    subtitle: 'Exquisite Swiss automatic movements, scratch-resistant sapphire crystal, and 24K gold bezel accents engineered for connoisseurs.',
    primaryBtnText: 'Shop Horology',
    primaryBtnLink: '/category/accessories',
    secondaryBtnText: 'Explore Luxury',
    secondaryBtnLink: '/shop',
    image: 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=1600&auto=format&fit=crop&q=85',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    badge: 'HI-RES ACOUSTICS & TECH',
    tag: 'Studio Audiophile Gear',
    titleLine1: 'Pure Acoustic Fidelity.',
    titleLine2: 'Studio ANC Audio.',
    subtitle: 'Audiophile-grade 40mm beryllium drivers, hybrid active noise cancellation, and handcrafted walnut spatial audio speakers.',
    primaryBtnText: 'Discover Tech',
  ...
  },
  {
    ...
    titleLine1: 'Nordic Velvet Living.',
    titleLine2: 'Bespoke Sanctuary.',
    subtitle: 'Architectural solid walnut furnishings, sculptural brass lighting, and panoramic silhouettes engineered for modern living.',
